...
create table public.admins (
  ...
  -- We store a hex SHA-256 hash of the password (NOT plain text) for
  -- compatibility with the in-app `hashPassword` helper. Supabase Auth
  -- is the primary login path; this column is used for cross-validation
