...
import { AUTH_MODE, DUMMY_ACCOUNTS, login, type Admin } from "../auth";
      ...
      <div className="relative w-full max-w-md rounded-3xl border border-amber-300/30 bg-gradient-to-br from-zinc-900/95 via-zinc-950/95 to-cyan-950/30 p-6 shadow-[0_30px_90px_-25px_rgba(251,191,36,0.45)] backdrop-blur-xl sm:p-7">
        ...
        {AUTH_MODE === "dummy" && (
          <div className="mt-5 rounded-xl border border-amber-300/30 bg-amber-500/5 p-3">
            <p className="text-[10px] uppercase tracking-wider text-amber-200/80">Demo accounts (development)</p>
            <p className="mt-1 text-[10px] text-amber-100/60">Hidden automatically in production builds.</p>
            <div className="mt-2 grid gap-2 sm:grid-cols-2">
              {DUMMY_ACCOUNTS.map((acc) => (
                ...
                >
                  <p className="font-bold">{acc.role === "super_admin" ? "Super Admin" : "Admin"}</p>
